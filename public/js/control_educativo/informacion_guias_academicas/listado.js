            ...
            if (response) {
                ...
                if (response.archivo_adjunto !== null) {
                    ...
                    $("#eliminar-archivo").html(
                        "<a href = '/estudiante/guia-academica/" +
                            id +
                            "/eliminar-archivo'>Eliminar archivo</a>"
                    );
                }
        ...
        $.ajax({
            ...
            success: function() {
                window.location.href =
                    "/estudiante/guia-academica/registrar/" +
                    id +
                    "?aceptado=true";
            },
            statusCode: {
...
$("#terminar-edicion").on("click", function() {
    if (validarEdicion()) {
        ...
        $("#form-actualizar").attr(
            "action",
            "/estudiante/guia-academica/actualizar/" + id_graduacion
        );
        $("#form-actualizar").trigger("submit");
    } else {
        $("#rellenar-campos-modificar")
            .fadeTo(2000, 500)
            .slideUp(500, function() {
