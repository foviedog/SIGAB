...
<div class="card mt-4">
    @if($actividad->autorizada == 1) {{-- Se verifica si la actividad aún no ha sido autorizada --}}
    ...
    <div class="card-body">
        ...
        <ul class="nav nav-tabs d-flex justify-content-between" id="opciones_tab" role="tablist">
            <div class="d-flex">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="info-esp-tab" href="#info-esp">Información específica</a>
                </li>
            </div>
            <div>
            </div>
                                ...
                                <div class="card-body d-flex flex-column justify-content-center align-items-center pb-4">
                                    ...
                                    <div class="w-90">
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control" type='text' name="certificacion_actividad" id="certificacion_actividad" value="{{$actividad->actividadInterna->certificacion_actividad}}" onkeypress="contarCaracteres(this,100)" disabled>
                                            <div class="input-group-append">
                                ...
                                <div class="d-flex justify-content-center mb-3">
                                    <div class="w-50">
                                        <div class="card shadow-sm rounded pb-2">
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <textarea type='text' class="form-control w-100" id="recursos" name="recursos" rows="4" onkeypress="contarCaracteres(this,500)" disabled> {{ $actividad->actividadInterna->recursos }} </textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
