            ...
            <div class="card shadow pb-2">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs" id="opciones-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="act-int-tab" href="{{ route('perfil.mis-actividades') }}">Actividades internas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="act-prom-tab" href="{{ route('perfil.mis-actividades.promocion') }}">Actividades de promoción</a>
                        </li>
                    </ul>
