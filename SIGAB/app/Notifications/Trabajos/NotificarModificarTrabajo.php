...
class NotificarModificarTrabajo extends Notification
{
    use Queueable;
    ...
    {
        $mensaje = $this->persona->nombre." ".$this->persona->apellido." ha modificado información laboral para un estudiante.";
        return [
