...
@section('contenido')
    ...
    <div class="container bg-white py-4 px-3 mb-5 sombra w-75">
        <div class="d-flex justify-content-between">
            ...
            <div><a href="/estudiante/graduacion/{{ $estudiante->persona->persona_id }}" class="btn btn-rojo"><i
                        class="fas fa-chevron-left"></i> &nbsp; Regresar</a></div>
        </div>
        <hr>
        ...
        <div class="d-flex justify-content-center mb-2">
            <img class="rounded mb-3" width="160" height="160" id="imagen-modal"
                src="{{ asset('img/fotos/' . $estudiante->persona->imagen_perfil) }}" />
        </div>
            ...
            <div class="container w-75 ">
                ...
                <div class="d-flex justify-content-center flex-column mt-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control w-100" id="estado_civil" name="estado_civil" form="personal-form"
                            required>
                    ...
                    <div class=" mb-3">
                        ...
                        <input type='text' class="form-control" id="carrera_cursada" name="carrera_cursada"
                            onkeyup="contarCaracteres(this,80)" required>
                    </div>
                    ...
                    <div class=" mb-3">
                        ...
                        <input type='number' class="form-control" id="anio_graduacion" name="anio_graduacion"
                            onkeyup="contarCaracteres(this,4)" min="1975" required>
                    </div>
                </div>
