                                            ...
                                            <div class="col-3 mr-2">
                                                <div class="form-group">
                                                    ...
                                                    <select id="genero" name="genero" class="form-control w-100" required disabled>
                                                        ...
                                                        <option value="Masc" @if( $estudiante->persona->genero == "Masc" ) option selected @endif>Masculino</option>
                                                        <option value="Feme" @if( $estudiante->persona->genero == "Feme" ) option selected @endif>Femenino</option>
