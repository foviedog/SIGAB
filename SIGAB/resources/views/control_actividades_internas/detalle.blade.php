                                    ...
                                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                                        ...
                                        <div class="w-90">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control datetimepicker" name="rango_fechas" id="rango_fechas" placeholder="DD/MM/YYYY - DD/MM/YYYY" value="{{ $rango_fechas ?? null }}" disabled>
                                                <div class="input-group-append">
                                                    <span class="btn btn-contorno-rojo" data-toggle="tooltip" data-placement="top" title="Vaciar el campo de fecha" onclick="eliminarFechas(this);" disabled><i class="fas fa-calendar-times fa-lg"></i></span>
                                    ...
                                    <div class="card-body d-flex flex-column justify-content-center align-items-center pb-4">
                                        ...
                                        <div class="w-90 d-flex justify-content-between">
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="w-50 mx-2">
                                                    <input type="number" value="0" min="0" step="1" name="duracion" id="duracion" value="{{ $actividad->duracion }}" />
                                                </div>
                                                <div class="input-group-append">
                                    ...
                                    <div class="row d-flex justify-content-center my-4">
                                        <div class="input-group w-90">
                                            ...
                                            <div class="input-group-append">
                                                ...
                                                @if (!is_null($actividad->actividadInterna->personal_facilitador ))
                                            ...
                                            <div class="col-3">
                                                <div class="d-flex justify-content-center mb-2">
                                                    <div class="overflow-hidden rounded " style="max-width: 160px; max-height: 160px; ">
                                                        <img class="rounded mb-3" id="imagen-facilitador" src="{{ URL::asset('img/fotos/') }}/{{ $actividad->actividadInterna->personalFacilitador->persona->imagen_perfil ?? "" }}" style="max-width: 100%;  " />
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col">
                                    ...
                                    <div class="row d-flex justify-content-center my-4">
                                        <div class="input-group w-90">
                                            ...
                                            <input type='text' id="cedula-responsable" name="responsable_coordinar" class="form-control "
                                            value="{{ $actividad->responsableCoordinar->persona_id }}"
                                            required>
                                            <div class="input-group-append">
