        ...
        <div class="card-body">
            <div class="d-flex justify-content-between">
                ...
                <div>
                    ...
                    <a href="{{ route('actividad-promocion.show', $actividad->id) }}" class="btn btn-contorno-rojo"><i
                            class="fas fa-chevron-left "></i> &nbsp; Volver al detalle </a>

                </div>
            </div>
            <hr>
            <form action="{{ route('asistencia-promocion.show', $actividad->id) }}" method="GET" id="form-reload"
                style="display: none">
            ...
            @if ($mensaje == 'success')
                ...
                <div class="mensaje-container" id="mensaje-info" style="display:none;  ">
                    <div class="col-3 icono-mensaje d-flex align-items-center" id="icono-mensaje"
                        style="background-image: url('/img/recursos/iconos/success.png');"></div>
                    <div class="col-9 texto-mensaje d-flex align-items-center text-center" id="texto-mensaje"
            ...
            @elseif($mensaje == 'error')
                ...
                <div class="mensaje-container" id="mensaje-info" style="display:none; ">
                    <div class="col-3 icono-mensaje d-flex align-items-center" id="icono-mensaje"
                        style=" background-image: url('/img/recursos/iconos/error.png');"></div>
                    <div class="col-9 texto-mensaje d-flex align-items-center text-center" id="texto-mensaje"
                        style="color: #b30808e8; ">Ocurrió un error al agregar el participante</div>
                </div>
            @endif
            ...
            @if (Session::has('eliminado'))
                ...
                <div class="mensaje-container" id="mensaje-info" style="display:none;  ">
                    <div class="col-3 icono-mensaje d-flex align-items-center" id="icono-mensaje"
                        style="background-image: url('/img/recursos/iconos/success.png');"></div>
                    <div class="col-9 texto-mensaje d-flex align-items-center text-center" id="texto-mensaje"
                        style="color: #046704e8; "> {{ Session::get('eliminado') }} </div>
                </div>
            @endif
            ...
            <div class="row border-bottom pb-4 mb-4">
                            ...
                            <div class="container-fluid">
                                <div class="row d-flex justify-content-center align-items-center">
                                    <div class="col d-flex justify-content-center align-items-center" id="img-actividad">
                                        <img src="http://127.0.0.1:8000/img/logoEBDI.png" class="transicion-max-width"
                                            id="logo-EBDI" alt="logo_ebdi" style="max-width: 40%">
                                    </div>
                                    <div class="col-12 border-top d-flex align-items-center transicion-padding"
                                        id="info-actividad">
                                        <div class="w-100">
                                            <span class="my-1"> <strong>Nombre de actividad:</strong>
                                                ghdgdsrf</span> <br>
                                            <span class="my-1"> <strong>Fecha de la
                                                    actividad:</strong> 2021-03-11 <i class="far fa-arrow-alt-circle-right"
                                                    aria-hidden="true"></i>
                                                2021-03-05</span><br>
                ...
                <div class="col-6 ">
                    <form action="{{ route('asistencia-promocion.store') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <input class="form-control" type='hidden' id="actividad-id" name="acitividad_id"
                            value="{{ $actividad->id }}">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="d-flex justify-content-center mb-3">
                                            <div class="w-100">
                                                ...
                                                <div class="d-flex">
                                                    <input type='text' class="form-control w-100" id="cedula" name="cedula"
                                                        onkeyup="contarCaracteres(this,100)" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col">
                                        ...
                                        <div class="d-flex justify-content-center mb-3">
                                            <div class="w-100">
                                                ...
                                                <div class="d-flex">
                                                    <input type='text' class="form-control w-100" id="nombre" name="nombre"
                                                        onkeyup="contarCaracteres(this,60)" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col">
                                        ...
                                        <div class="d-flex justify-content-center mb-3">
                                            <div class="w-100">
                                                ...
                                                <div class="d-flex">
                                                    <input type='text' class="form-control w-100" id="apellidos"
                                                        name="apellidos" onkeyup="contarCaracteres(this,60)" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="d-flex justify-content-center mb-3">
                                            <div class="w-100">
                                                ...
                                                <div class="d-flex">
                                                    <input type='text' class="form-control w-100" id="correo" name="correo"
                                                        onkeyup="contarCaracteres(this,100)">
                                            ...
                                            <div class="w-100">
                                                ...
                                                <div class="d-flex">
                                                    <input type='text' class="form-control w-100" id="telefono"
                                                        name="telefono" onkeyup="contarCaracteres(this,60)">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="d-flex justify-content-center mb-3">
                                            <div class="w-100">
                                                ...
                                                <div class="d-flex">
                                                    <input type='text' class="form-control w-100" id="procedencia"
                                                        name="procedencia" onkeyup="contarCaracteres(this,60)">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-11">
                        <div class="card shadow">
                            <div class="d-flex justify-content-between card-header py-3">
                                ...
                                <div>
                                    <button href="" class="btn btn-contorno-azul-una" id="btn-listar-todo"><i
                                            class="fas fa-redo"></i>&nbsp; Listar todo </button>
                                </div>
                            </div>
                            <form action="{{ route('asistencia-promocion.show', $actividad->id) }}" method="GET"
                                id="form-busqueda">
                                <div class="row pt-3 px-3">
                                    ...
                                    <div class="col-md-10 d-flex justify-content-start">
                                        <div class="d-flex justify-content-end w-25">
                                            <div class="text-md-right dataTables_filter input-group mb-3 ">
                                                ...
                                                <div class="input-group mb-2">
                                                    <input type="text" class="form-control w-50" id="filtro" name="filtro"
                                                        placeholder="Búsqueda del participante."
                                                        value="{{ $filtro ?? '' }}">
                                                    <div class="input-group-append">
                                                        <div class="input-group-text texto-azul-una" data-toggle="tooltip"
                                                            data-placement="top"
                                                            title="Buscar por nombre, apellido o cédula">
                                        ...
                                        <div>
                                            <button class="btn btn-rojo ml-3" type="submit">Buscar &nbsp;<i
                                    ...
                                    <div class="col-md-2 ">
                                        <div class=" d-flex justify-content-end" aria-controls="dataTable">
                                            ...
                                            <select class="form-control form-control-sm custom-select custom-select-sm w-50"
                                                name="itemsPagina">
                                ...
                                <tbody id="lista-participantes">
                                    ...
                                    @foreach ($listaAsistencia as $participante)
                                        <tr id="" class="cursor-pointer">
                                            ...
                                            <td>
                                                <button id="" class="btn btn-contorno-rojo" type="button"
                                                    onclick="mostrarInfo(this)"><i class="fas fa-eye"></i>
                                                    &nbsp;Detalle</button>
                                            </td>
                                            <form action="" method="post">
                                                ...
                                                @csrf
                                                <td>
                                                    <button class="btn btn-contorno-rojo" type="submit"><i
                                                            class="fas fa-times-circle"></i>&nbsp; Eliminar</button>
                                                </td>
                ...
                <div class="col-1">
                    <div class="info-card" style="padding: 2px 0; max-width: 100%; ">
                        <span style="font-size: 36px; font-weight: bolder;"
                            id="total">{{ $listaAsistencia->total() }}</span><br>
