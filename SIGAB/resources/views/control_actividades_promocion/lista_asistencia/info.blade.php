<div class="modal fade" id="informacion-participante" tabindex="-1" aria-hidden="true" data-keyboard="false">
    <div class="modal-dialog  modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header " style="border-bottom: 0px;">
                <div id="imagen-perfil-modal" class="imagen-perfil-modal overflow-hidden rounded-circle ">
                    {{-- <img id="iagen-info" style="max-width: 100%;" src='{{ asset("/img/fotos/default.jpg") }}' /> --}}
                </div>
            </div>
