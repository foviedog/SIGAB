                                            ...
                                            <div class="col-4 ">
                                                <div class="form-group">
                                                    ...
                                                    <select id="genero" name="genero" class="form-control w-100" required disabled>
                                                        ...
                                                        <option value="Masc" @if( $personal->persona->genero == "Masc" ) selected @endif>Masculino</option>
                                                        <option value="Feme" @if( $personal->persona->genero == "Feme" ) selected @endif>Femenino</option>
